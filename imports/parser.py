...
class Parser:
    ...
    def __possible_tokens(self, token: TypedToken) -> list[int]:
        ...
        match token.type:
            ...
            case tokentypes.END: return Parser.END

            case tokentypes.INSTRUCTION: return Parser.INSTRUCTION

            case tokentypes.ADDRESSING_MODE: return Parser.ADDRESSING_MODE

            case tokentypes.VALUE | tokentypes.REGISTER: return Parser.OPERAND

            case tokentypes.LABEL: return Parser.LABEL

            case tokentypes.SEPARATOR: return Parser.SEPARATOR

            case tokentypes.RIGHT_BRACE | tokentypes.LEFT_BRACE: return Parser.SCOPE

            case tokentypes.ASSEMBLY_DIRECTIVE: return Parser.ASSEMBLY_DIRECTIVE
