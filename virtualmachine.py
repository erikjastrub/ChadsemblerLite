...
"""
    ...
    def __handle_instruction(self, machine_code: str, program_counter: int) -> None:
        ...
        lower = upper
        upper += self.__addressing_mode_bits
        addressing_mode: str = machine_code[lower:upper]

        lower = upper
        upper += self.__operand_bits
        source_operand: str = machine_code[lower:upper]

        lower = upper
        upper += self.__operand_bits
        destination_operand: str = machine_code[lower:upper]
